...
class OccupancyGrid(object):
    ...
    def is_occupied(self, position):
        return self._values[self.get_index(position)] % 4 == OCCUPIED or self._values[
            self.get_index(position)] % 4 == UNKNOWN
...
def explore_diagonal(occupancy_grid, current_node, directionX, directionY):
    ...
    while (True):
        ...
        if (not occupancy_grid.is_free_index((cur_x + directionX, cur_y))) and occupancy_grid.is_free_index(
                (cur_x + directionX, cur_y + directionY)):
            toExplore.append(new_node)
            return toExplore
        ...
        if (not occupancy_grid.is_free_index((cur_x, cur_y + directionY))) and occupancy_grid.is_free_index(
                (cur_x + directionX, cur_y + directionY)):
            toExplore.append(new_node)
            return toExplore
...
def explore_cardinal(occupancy_grid, current_node, directionX, directionY):
    ...
    while (True):
        ...
        if directionX == 0:
            if (not occupancy_grid.is_free_index((cur_x + 1, cur_y))) and occupancy_grid.is_free_index(
                    (cur_x + 1, cur_y + directionY)):
                return new_node
            if (not occupancy_grid.is_free_index((cur_x - 1, cur_y))) and occupancy_grid.is_free_index(
                    (cur_x - 1, cur_y + directionY)):
                return new_node
            ...
            if (not occupancy_grid.is_free_index((cur_x, cur_y + 1))) and occupancy_grid.is_free_index(
                    (cur_x + directionX, cur_y + 1)):
                return new_node
            if (not occupancy_grid.is_free_index((cur_x, cur_y - 1))) and occupancy_grid.is_free_index(
                    (cur_x + directionX, cur_y - 1)):
                return new_node
